...
export const ANTIGRAVITY_PATH = process.env.ANTIGRAVITY_PATH || '';
...
export const AUTH_COOKIE_NAME = 'liftoff_auth';
...
const packageMetadata = JSON.parse(readFileSync(join(PROJECT_ROOT, 'package.json'), 'utf8'));
export const VERSION = String(packageMetadata.version || '0.0.0');
